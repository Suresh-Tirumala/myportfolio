...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "Heat-aware pedestrian navigation system that optimizes routes for thermal safety by evaluating surface temperatures, shade canopy, and classic distance for the shortest, coolest, and balanced paths.",
    details: "A full-stack geographic application built with React, MapLibre, Python, and PostGIS designed to mitigate urban heat island exposure. By ingesting real-time surface temperatures from the FortyGuard API and pedestrian networks from OpenStreetMap, the custom Python routing engine (using NetworkX and GeoPandas) re-weights street graphs so algorithms prefer shaded pathways. Users can compare the shortest, coolest, and balanced routes with live thermal overlays, shade scores, and navigation steps—trading minimal extra distance for significantly lower heat exposure.",
